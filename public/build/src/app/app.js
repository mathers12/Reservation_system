(function(app) {
    ...
    app.service('resolveService', ['$q', '$http', '$window', '$location', '$resource', function($q,$http,$window,$location,$resource) {
        return {
    ...
    app.controller('AppController', ['$scope', '$mdDialog', '$mdToast', '$location', '$http', '$window', '$rootScope', function ($scope,$mdDialog, $mdToast, $location,$http,$window,$rootScope) {
